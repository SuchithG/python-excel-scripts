...
def get_dates():
    ...
    first_day_start_time = previous_month.replace(day=1).strftime('%d-%b-%Y 00:00:00')
    last_day_end_time = last_day.strftime('%d-%b-%Y 23:59:59')
...
def execute_queries_and_save_to_excel(connection, queries, file_path):
    ...
    for query_name, query in queries.items():
        ...
        # Write the data to a seperate sheet in the Excel file
