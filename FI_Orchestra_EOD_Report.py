...
try:
    ...
    log_message("Before conversion to integers")
    log_dataframe(df_daily_report_processed[float_columns], "Daily Report Floats")
    ...
    log_message("After conversion to integers")
    log_dataframe(df_daily_report_processed[float_columns], "Daily Report Floats")
    ...
    log_message("Leave Tracker HTML generated")
    log_message("Styled Daily Report HTML generated")
    log_message("Third Table HTML generated")
    log_message("Fourth Table HTML generated")
    ...
    log_message("EOD report has been sent to: " + to_email)
